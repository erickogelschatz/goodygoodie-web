...
export function IoHomeOutline(props: IconProps) {
  return (
    <Icon {...props}>
...
export function IoSwapVerticalOutline(props: IconProps) {
  return (
    <Icon {...props}>
      <polyline points="7 16 7 4 3 8" />
      <polyline points="7 4 11 8" />
      <polyline points="17 8 17 20 13 16" />
      <polyline points="17 20 21 16" />
    </Icon>
  )
}

export function IoPricetagOutline(props: IconProps) {
  return (
    <Icon {...props}>
...
export function IoSettingsOutline(props: IconProps) {
  return (
    <Icon {...props}>
      <circle cx="12" cy="12" r="3" />
...
export function IoLogOutOutline(props: IconProps) {
  return (
    <Icon {...props}>
...
export function IoGiftOutline(props: IconProps) {
  return (
    <Icon {...props}>
